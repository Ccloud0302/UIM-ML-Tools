...
public interface IKGraphRepository {
	 ...
	 * @return
	 */
	List<HashMap<String, Object>>getdomainnodes(String domain);
	 ...
	 * @param oldName
	 */
	void updatedomainname(String oldName, String domainName);
	...
	HashMap<String, Object> getNodeAttrById(String domain, int nodeid);
}
